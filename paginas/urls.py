...
from .views import HomePageView, CadastroCreateView, LoginPageView, SobrePageView, AreaAlunoPageView, LogaPageView, AreaProfPageView
...
urlpatterns = [
    ...
    path('areaprof', AreaProfPageView.as_view(), name='areaprof'),
